...
const AllProjects = () => {
  ...
  const handleCreateProject = (projectData) => {
    ...
    // If a supervisor was selected, send supervisor request
    if (projectData.supervisor && projectData.supervisor !== 'Not assigned' && projectData.supervisor !== '') {
      try {
        ...
        const supervisorRequest = {
          ...
          supervisorName: projectData.supervisor,
        ...
        console.log('📤 Supervisor request sent to:', projectData.supervisor);
        alert(`✅ Project created! Supervision request sent to ${projectData.supervisor}`);
      } catch (e) {
        console.error('Failed to send supervisor request:', e);
      }
    }
